...
from poorcharlie.datasources.pdf_extract import extract_pdf_markdown, extract_sections
from poorcharlie.datasources.resolver import resolve_filing_fetcher, resolve_market
...
from poorcharlie.schemas.filing import FilingOutput
...
class FilingAgent(BaseAgent):
    ...
    async def _override_with_structured_data(
        ...
        *,
        ...
        """
        from poorcharlie.datasources.akshare_source import fetch_structured_financials

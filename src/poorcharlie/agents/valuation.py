...
from poorcharlie.schemas.valuation import IntrinsicValueRange, ValuationOutput
...
class ValuationAgent(BaseAgent):
    ...
    def _build_user_context(self, input_data: BaseModel, ctx: Any = None) -> dict[str, Any]:
        ...
        if ctx is not None:
            from poorcharlie.agents.context_helpers import data_for_valuation, format_json
